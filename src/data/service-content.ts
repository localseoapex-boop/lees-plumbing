...
export const hubContent: Record<string, HubContent> = {
  ...
  hvac: {
    heroHeading: 'Heating and Cooling Services in Hyde Park, Utah',
    heroLede:
      "Lee's Plumbing is based in Hyde Park and serves homeowners across Cache Valley. We repair, replace, and maintain furnaces, air conditioners, and heat pumps, so your home stays comfortable through a Northern Utah winter and summer alike.",
    trustIntro:
      'A local company that handles the heating and cooling equipment your home depends on.',
    supportingHeading: 'Heating and Cooling Help for Cache Valley Homes',
    supportingParagraphs: [
      "Northern Utah asks a lot of a home comfort system. Cache Valley winters run long and cold, summers turn hot and dry, and the same house has to stay livable through both. Lee's Plumbing services the equipment that carries that load, which means furnaces, air conditioners, and heat pumps.",
      'The work splits into three kinds. Repair is what you need when a system has stopped keeping up, whether that is a furnace that will not light on a cold morning or an air conditioner blowing air that is not cold. Replacement and installation come into play when equipment has aged past the point where repair is a sensible investment, and a properly sized new unit will run more efficiently than the one it replaces. Seasonal maintenance is the quieter third category, and it is the one that catches small problems while they are still small.',
      'A heating or cooling system usually gives some warning before it fails outright. Longer run times, uneven temperatures from room to room, new noises at startup, and rising energy use for the same comfort are all signals worth paying attention to. Systems tend to fail on the coldest and hottest days, because that is when they are working hardest, so it is worth looking into a change in behavior before the season turns.',
    ],
    directoryHeading: 'Heating & Cooling Services We Offer',
    directoryIntro:
      'Choose the service that matches what your system is doing. Each page explains the work in more detail.',
    groups: [
      { title: 'Cooling', slugs: ['ac-repair', 'ac-installation'] },
      { title: 'Heating', slugs: ['furnace-repair', 'furnace-installation'] },
      { title: 'Year-Round Comfort', slugs: ['heat-pump-services', 'hvac-maintenance'] },
    ],
    areasHeading: 'Heating & Cooling Service Across Cache Valley',
    areasIntro:
      'Our office is in Hyde Park and we serve the surrounding communities. Choose your city to see heating and cooling service there.',
    faqHeading: 'Common Heating and Cooling Questions',
    faqs: [
      {
        question: 'What heating and cooling services are available?',
        answer:
          'We repair and install furnaces and air conditioners, service and install heat pumps, and perform seasonal maintenance on heating and cooling equipment. That covers a system that has stopped working, a system that is aging out and needs replacing, and a system that is running but should be checked before the season changes.',
      },
      {
        question: "Does Lee's Plumbing service furnaces and air conditioners?",
        answer:
          'Yes. Despite the name, we work on both sides of home comfort. Furnaces and air conditioners are the two most common systems in Cache Valley homes and we repair, replace, and maintain both, along with heat pumps that handle heating and cooling from a single system.',
      },
      {
        question: 'When should HVAC equipment be inspected?',
        answer:
          'The useful pattern is to look at cooling equipment in spring before the first hot stretch, and heating equipment in fall before the first hard freeze. Checking a system while you are not yet depending on it means a problem gets found on a mild day rather than on the night it fails.',
      },
      {
        question: 'How can homeowners tell a system may need repair?',
        answer:
          'Watch for changes rather than absolutes. A furnace that short cycles on and off, an air conditioner that runs constantly without cooling the house, weak airflow at the vents, new grinding or squealing at startup, uneven temperatures between rooms, and energy bills climbing without a change in habits are all reasons to have the system looked at.',
      },
      {
        question: 'What Cache Valley communities are served?',
        answer:
          'We are based in Hyde Park and serve Logan, North Logan, Smithfield, Providence, Hyrum, Nibley, River Heights, Wellsville, and Richmond, along with Hyde Park itself.',
      },
    ],
    finalCtaHeading: 'Need Heating or Cooling Service in Cache Valley?',
    finalCtaBody:
      'Give us a call and tell us what your system is doing. We will let you know how we can help.',
  },
};
 ...
 * data/locations.ts: there is an office in Hyde Park, ten cities are served, and
 * both trades are offered. Nothing claims licensing, insurance, financing,
...
export const TRUST_CARDS: readonly { title: string; body: string }[] = [
  ...
  {
    title: 'Plumbing and Heating & Cooling',
    body: 'Two trades under one roof, which means one call whether the problem is a pipe or a furnace.',
  },
  {
...
export const subServiceContent: Record<string, SubServiceContent> = {
  ...
  'ac-repair': {
    supportingParagraphs: [
      'An air conditioner does not make cold air. It moves heat out of your house and rejects it outside, using refrigerant that changes state as it cycles between the indoor coil and the outdoor unit. That is worth knowing, because it explains most of the ways an air conditioner fails. Anything that interferes with heat moving through that loop shows up as a system that runs and runs without cooling the house.',
      'The common faults follow from that. A dirty filter or a fouled coil blocks the airflow the system depends on. Low refrigerant, which is always a leak rather than consumption, means less heat gets carried out per cycle. A failed capacitor leaves the compressor or fan motor unable to start. A thermostat that is misreading the room will run the system at the wrong times. A blocked condensate drain can shut the unit down on a safety switch.',
      'Cache Valley summers are hot and dry, and an air conditioner here works hardest on exactly the days you most want it. That is not a coincidence. A system that is marginal because a coil is dirty or refrigerant is low will keep up on a mild day and fail on a hot one, which is why a unit that seems to be struggling in June is worth attention before July.',
    ],
    signsHeading: 'Signs You May Need AC Repair',
    signs: [
      {
        title: 'The air coming out is not cold',
        body: 'Air from the vents that is room temperature or merely cool means the system is not moving heat out of the house, even though it is running.',
      },
      {
        title: 'Weak airflow at the vents',
        body: 'Air that is cold but barely moving points at a blocked filter, a failing blower motor, or a duct problem rather than the refrigerant circuit.',
      },
      {
        title: 'The system short cycles',
        body: 'Turning on and off every few minutes without completing a cooling cycle stresses the compressor and usually means something is wrong.',
      },
      {
        title: 'It runs constantly and never satisfies',
        body: 'A unit that never reaches the setpoint on a normal day is losing capacity somewhere. It is working, but not effectively.',
      },
      {
        title: 'New noises',
        body: 'Grinding, screeching, or loud clicking at startup are mechanical or electrical signals. A hard clicking sound that ends in nothing often points at a failed capacitor.',
      },
      {
        title: 'Cooling costs climbing without a habit change',
        body: 'When the same comfort costs more than it did last summer, the system is working harder than it should to deliver it.',
      },
    ],
    causesHeading: 'Common Reasons Air Conditioners Stop Cooling',
    causes: [
      {
        title: 'A dirty filter or blocked airflow',
        body: 'The most common cause and the cheapest to address. Restricted airflow across the indoor coil cripples the system and can freeze the coil outright.',
      },
      {
        title: 'Low refrigerant from a leak',
        body: 'Refrigerant is not consumed. If a system is low, it leaked, and simply adding more without finding the leak means it will be low again.',
      },
      {
        title: 'A failed capacitor',
        body: 'The capacitor gives the compressor and fan motors the jolt they need to start. When it fails the unit hums or clicks and does not run. It is a frequent culprit and a normal repair.',
      },
      {
        title: 'A dirty condenser coil',
        body: 'The outdoor coil has to release heat into the air. Caked with dust, cottonwood, and grass clippings, it cannot, and the whole system loses capacity.',
      },
      {
        title: 'Thermostat problems',
        body: 'A thermostat that is misreading the room, wired incorrectly, or simply failing will run the system at the wrong times or not at all.',
      },
      {
        title: 'A frozen evaporator coil',
        body: 'Ice on the indoor coil is a symptom rather than a cause. It usually traces back to restricted airflow or low refrigerant, and running the system that way makes it worse.',
      },
    ],
    faqs: [
      {
        ...
        answer:
          'The system is moving air but not moving heat. The common explanations are a restricted filter or coil choking the airflow, a refrigerant leak that has left the system undercharged, a failed capacitor leaving the compressor unable to start while the fan keeps turning, or a frozen evaporator coil. Checking and replacing the filter is worth doing first, because it is free and it is often the answer.',
      },
      {
        question: 'Does an air conditioner use up refrigerant over time?',
        answer:
          'No, and this is an important one. Refrigerant circulates in a sealed loop and is not consumed the way fuel is. If a system is low on refrigerant, it has a leak. Topping it up without finding and fixing that leak means paying to fill a system that will be low again, so the leak is the actual repair.',
      },
      {
        question: 'Why is there ice on my air conditioner?',
        answer:
          'Ice on the indoor coil almost always means the airflow across it is restricted or the refrigerant charge is low. In both cases the coil gets colder than it should and condensation on it freezes. It is a symptom rather than the problem. Running the system with a frozen coil makes matters worse, so it is better to shut the cooling off, let it thaw, and have the cause looked at.',
      },
      {
        question: 'Should I repair my air conditioner or replace it?',
        answer:
          'Capacitors, contactors, thermostats, and blower motors are ordinary repairs and are generally worth doing. The calculation shifts when the compressor has failed, when the unit is well into its service life, or when repairs have started coming every season. At that point the money is often better spent on a properly sized replacement that will run more efficiently. We will tell you which situation we think you are in rather than deciding it for you.',
      },
      {
        question: 'My AC is short cycling. What does that mean?',
        answer:
          'Short cycling is when the system turns on and off every few minutes without completing a proper cooling cycle. It is hard on the compressor, which is the expensive part. The causes range from a dirty filter or coil, to a thermostat placed where it reads the temperature wrong, to a system that is oversized for the house and satisfies the thermostat before it has actually conditioned the space. It is worth diagnosing rather than living with.',
      },
    ],
    related: ['ac-installation', 'hvac-maintenance', 'heat-pump-services'],
  },

  'ac-installation': {
    supportingParagraphs: [
      'Replacing an air conditioner is a decision with a long tail. The system you put in will run for many summers, and how well it performs across those summers is decided largely on the day it is installed. Sizing and installation quality matter more than most homeowners are told.',
      'Bigger is not better, and this is the single most common misconception about air conditioning. An oversized unit cools the air quickly, satisfies the thermostat, and shuts off before it has run long enough to pull meaningful humidity out of the house or to condition the space evenly. The result is a house that is cold and clammy, temperatures that swing, and a compressor that short cycles its way to an early failure. An undersized unit has the opposite problem and simply never keeps up on the hottest days.',
      'So the size of the system should follow the house rather than a catalog. Square footage is only the starting point, and insulation, window area and orientation, ceiling height, and how the ductwork actually runs all affect what the home needs. We look at the house and talk through the options with you before anything is decided.',
    ],
    signsHeading: 'Signs It May Be Time to Replace Your Air Conditioner',
    signs: [
      {
        title: 'The compressor has failed',
        body: 'The compressor is the heart of the system and the most expensive component. On an older unit, its failure usually shifts the decision toward replacement.',
      },
      {
        title: 'Repairs are coming every season',
        body: 'One repair is normal. A pattern of repairs each summer means the system is telling you where it is in its life.',
      },
      {
        title: 'The unit is well into its service life',
        body: 'Efficiency drops and failures cluster as a system ages. Past a certain point, money spent on repairs is money not spent on a system that will not need them.',
      },
      {
        title: 'It never keeps up on hot days',
        body: 'A system that cannot hold the house on the hottest afternoons may be undersized, or it may have lost too much capacity to keep doing the job.',
      },
      {
        title: 'Cooling costs keep climbing',
        body: 'A steady rise in what it costs to keep the house comfortable, with no change in habits, points at a system losing efficiency.',
      },
      {
        title: 'The house is cold but clammy',
        body: 'That combination often means the existing unit is oversized and short cycling, which is a sizing problem a replacement is the chance to correct.',
      },
    ],
    causesHeading: 'Reasons to Consider AC Installation',
    causes: [
      {
        title: 'The existing system has failed',
        body: 'The most common reason. When a major component goes on an aging unit, replacement is frequently the better use of the money.',
      },
      {
        title: 'Better efficiency',
        body: 'Newer equipment generally delivers the same cooling for less energy than an aging system that is fighting a worn compressor and a fouled coil.',
      },
      {
        title: 'Correcting a sizing mistake',
        body: 'If the house has always been either clammy or unable to keep up, the existing unit may simply be the wrong size. Replacement is the opportunity to fix that.',
      },
      {
        title: 'More even comfort',
        body: 'A properly sized system runs longer, gentler cycles, which evens out temperatures between rooms rather than blasting and shutting off.',
      },
      {
        title: 'Planning ahead of a failure',
        body: 'Replacing a system on your schedule is a calmer decision than replacing one that quit during the hottest week of the year.',
      },
      {
        title: 'Pairing with a heating replacement',
        body: 'When a furnace is being replaced anyway, it can be a practical time to look at the cooling side, since the two share ductwork and the indoor coil.',
      },
    ],
    faqs: [
      {
        question: 'What size air conditioner does my home need?',
        answer:
          'More goes into it than square footage alone. Insulation levels, window area and which way they face, ceiling height, how the house is laid out, and the condition of the ductwork all change the answer, and two houses of identical size can genuinely need different equipment. It is the part of the decision worth taking time over, because the size you land on stays with the system for its entire life. We will look at your home and talk it through with you.',
      },
      {
        question: 'Is a bigger air conditioner better?',
        answer:
          'No, and it is the most common misconception in this trade. An oversized unit cools the air fast, hits the thermostat setpoint, and shuts off before it has run long enough to remove humidity or condition the house evenly. You end up with a home that is cold and clammy, temperatures that swing, and a compressor that short cycles and wears out early. The right size, not the biggest size, is the goal.',
      },
      {
        question: 'Should I replace my furnace and air conditioner at the same time?',
        answer:
          'Not necessarily, but it is worth thinking about when both are aging, because the two systems share ductwork and the indoor coil sits in the furnace airflow. If one is being replaced and the other is close to the end of its life, doing them together can avoid paying twice to open up the same equipment. If the other system has years left in it, there is no need to replace it early.',
      },
      {
        question: 'How long does a new air conditioner last?',
        answer:
          'It depends heavily on how well it was sized, how well it was installed, and whether it gets maintained. A correctly sized unit that runs long, steady cycles and gets its filter and coils kept clean lives a very different life than an oversized one that short cycles for years. We would rather talk about what affects the answer than quote a number that may not hold for your equipment.',
      },
      {
        question: 'Will a new air conditioner lower my energy bill?',
        answer:
          'It generally helps, particularly if the outgoing unit was old, oversized, or struggling with a fouled coil. How much depends on what you are replacing, how the house is built, how you use it, and your rates, so we are not going to attach a percentage to it. What we can say is that a correctly sized, properly installed system does the same work with less strain than one that is fighting itself.',
      },
    ],
    related: ['ac-repair', 'furnace-installation', 'hvac-maintenance'],
  },

  'furnace-repair': {
    supportingParagraphs: [
      'A furnace that will not light on a January morning in Cache Valley is not a minor inconvenience. It is also, fortunately, one of the more diagnosable pieces of equipment in a house, because a furnace runs through a defined startup sequence and a failure usually stops it at an identifiable point in that sequence.',
      'The sequence matters. The thermostat calls for heat, an inducer fan clears the flue, a pressure switch confirms it, the igniter heats or the pilot lights, the gas valve opens, the flame sensor confirms a flame is present, and the blower comes on to move warm air. If the flame sensor is dirty, the furnace will light and then shut down seconds later, over and over. If the pressure switch does not close, it will never light at all. Different failures produce different behavior, and that behavior is the diagnostic clue.',
      'Some furnace symptoms are comfort problems and some are safety matters. A furnace that short cycles is wearing itself out. A furnace that is producing a smell of gas, or that has a cracked heat exchanger, is a different category entirely and the right response is to shut it down and call. Combustion equipment deserves that respect.',
    ],
    signsHeading: 'Signs You May Need Furnace Repair',
    signs: [
      {
        title: 'No heat at all',
        body: 'The furnace runs but the air is not warm, or it does not start at all. Ignition components, the pressure switch, and the gas valve are the usual places to look.',
      },
      {
        title: 'It lights and then shuts off',
        body: 'A furnace that fires for a few seconds and quits, repeatedly, is often failing to confirm its flame. A dirty flame sensor is a very common cause of exactly this.',
      },
      {
        title: 'Short cycling',
        body: 'Turning on and off rapidly without completing a heating cycle wears the equipment and usually indicates a restriction, a sensor problem, or an overheating condition.',
      },
      {
        title: 'Weak airflow or cold spots',
        body: 'Rooms that will not warm up, or vents barely moving air, can point at the blower motor, a badly restricted filter, or ductwork.',
      },
      {
        title: 'New noises at startup',
        body: 'Banging, grinding, screeching, or a rumble that was not there last winter are all worth having looked at rather than waiting out.',
      },
      {
        title: 'A gas smell or a soot buildup',
        body: 'Treat this as a safety matter rather than a repair. Shut the system down and call. Do not run a furnace you suspect is not burning cleanly.',
      },
    ],
    causesHeading: 'Common Causes of Furnace Problems',
    causes: [
      {
        title: 'A dirty flame sensor',
        body: 'One of the most frequent furnace faults. The sensor confirms a flame is present, and when it is coated it cannot, so the furnace shuts the gas off seconds after lighting as a safety response.',
      },
      {
        title: 'Ignition failure',
        body: 'A cracked hot surface igniter or a pilot and thermocouple that have failed will stop the sequence before the burner ever lights.',
      },
      {
        title: 'A clogged filter',
        body: 'Restricted airflow makes the furnace run hot, which can trip the high limit switch and shut it down. It is the cheapest possible cause and worth ruling out first.',
      },
      {
        title: 'A failing blower motor',
        body: 'The blower moves the heat into the house. When it weakens or fails, the furnace can produce heat that never arrives at the vents.',
      },
      {
        title: 'Pressure switch and venting faults',
        body: 'The furnace confirms the flue is clear before it lights. A blocked vent, a failed inducer, or a stuck switch will keep it from starting at all, which is a safety feature working as intended.',
      },
      {
        title: 'Thermostat problems',
        body: 'A thermostat that is failing, miswired, or reading the room incorrectly will call for heat at the wrong times or fail to call for it.',
      },
    ],
    faqs: [
      {
        question: 'Why does my furnace turn on and then shut off after a few seconds?',
        answer:
          'That specific pattern, lighting and then quitting shortly after, most often means the furnace cannot confirm that a flame is actually present, so it shuts the gas off as a safety response. A dirty flame sensor is the classic cause. It can also be a venting or pressure switch problem. The behavior is a useful clue, because a furnace that lights and quits is failing at a different point in its sequence than one that never lights at all.',
      },
      {
        question: 'Why does my furnace keep short cycling?',
        answer:
          'Short cycling means it runs briefly, shuts off, and starts again without properly completing a heating cycle. The most common cause is a restricted filter, which makes the furnace overheat and trip its high limit switch. It can also come from a thermostat that is placed badly or failing, or a furnace that is oversized for the house. It is hard on the equipment, so it is worth diagnosing rather than tolerating.',
      },
      {
        question: 'Is a furnace problem ever a safety issue?',
        answer:
          'Yes, and it is worth being direct about it. A furnace burns fuel, and equipment that is not burning or venting cleanly can produce carbon monoxide. If you smell gas, see soot around the unit, or have reason to suspect a cracked heat exchanger, the right response is to shut the system down and call rather than to keep running it. Working carbon monoxide detectors in the home are a sensible precaution regardless.',
      },
      {
        question: 'Should I repair or replace my furnace?',
        answer:
          'Flame sensors, igniters, capacitors, pressure switches, and blower motors are ordinary repairs and are usually worth doing on a sound furnace. The picture changes when the heat exchanger is cracked, when the unit is well into its service life and needing repairs every winter, or when the repair is a large fraction of what a replacement would cost. We will tell you honestly which of those we think you are looking at.',
      },
      {
        question: 'Why are some rooms cold when the furnace is running?',
        answer:
          'If the furnace is producing heat but it is not arriving evenly, the issue is usually distribution rather than the furnace itself. A restricted filter, a weakening blower, closed or blocked registers, leaky or poorly balanced ductwork, and insulation differences between rooms all produce cold spots. It is worth working out which, because replacing a furnace will not fix a duct problem.',
      },
    ],
  ...
  'furnace-installation': {
    supportingParagraphs: [
      'A furnace in Cache Valley earns its keep. Winters here are long and genuinely cold, and the heating system runs for months rather than weeks. That makes furnace replacement a decision worth taking time over, because you will live with the result through every cold snap for years.',
      'As with cooling, sizing is where the outcome is decided, and bigger is not better. An oversized furnace heats the air quickly, satisfies the thermostat, and shuts off, then repeats. That short cycling produces uneven temperatures, a house that feels drafty because the blower is not running long enough to circulate air, and unnecessary wear on the equipment. A correctly sized furnace runs longer, steadier cycles and heats the house more evenly.',
      'The other half of the decision is what surrounds the furnace. Venting matters, because this is combustion equipment. The gas supply has to be adequate. The ductwork has to be able to carry the airflow a new unit expects. Those are the things worth looking at before a furnace is chosen, and we go through them with you rather than leaving them to be discovered later.',
    ],
    signsHeading: 'Signs It May Be Time to Replace Your Furnace',
    signs: [
      {
        title: 'The heat exchanger is cracked',
        body: 'This is the one that ends the conversation. A cracked heat exchanger is a combustion safety problem and the furnace should not continue in service.',
      },
      {
        title: 'Repairs are coming every winter',
        body: 'A furnace that needs attention each season is past the point where repair is the economical path.',
      },
      {
        title: 'The unit is well into its service life',
        body: 'Older furnaces are less efficient by design and by wear, and their failures cluster as they age.',
      },
      {
        title: 'Heating costs keep climbing',
        body: 'Rising bills for the same comfort, with no change in habits or rates, mean the furnace is working harder to produce the same heat.',
      },
      {
        title: 'The house heats unevenly',
        body: 'Persistent cold rooms and temperature swings can indicate a furnace that is the wrong size for the house, which a replacement is the chance to correct.',
      },
      {
        title: 'The furnace is getting noticeably louder',
        body: 'A unit that has grown loud over the years is usually telling you about wear in the blower and the mechanical components.',
      },
    ],
    causesHeading: 'Reasons to Consider Furnace Installation',
    causes: [
      {
        title: 'The existing furnace has failed',
        body: 'When a major component goes on an aging unit, particularly the heat exchanger, replacement rather than repair is generally the right answer.',
      },
      {
        title: 'Better efficiency',
        body: 'A modern, correctly sized furnace converts more of the fuel it burns into heat in your house than an older unit that is fighting wear.',
      },
      {
        title: 'More even heat',
        body: 'A properly sized furnace runs longer, gentler cycles, which circulates air and evens out the difference between rooms.',
      },
      {
        title: 'Correcting a sizing mistake',
        body: 'A house that has always had cold rooms and a furnace that blasts and shuts off may simply have the wrong unit in it.',
      },
      {
        title: 'Safety',
        body: 'Combustion equipment that is no longer venting or burning cleanly is not something to nurse along through another winter.',
      },
      {
        title: 'Replacing before a failure',
        body: 'Choosing a furnace in October is a better experience than choosing one on the coldest night of the year with no heat in the house.',
      },
    ],
    faqs: [
      {
        question: 'What size furnace does my home need?',
        answer:
          'Square footage is only the starting point. Insulation, window area and orientation, ceiling heights, how the house is laid out, and the capacity of the existing ductwork all feed into the answer, and two homes of the same size can legitimately need different equipment. Getting the size right matters more than almost any other part of the decision, so it is worth looking at the actual house rather than working from a rule of thumb.',
      },
      {
        question: 'Is a bigger furnace better for a cold climate?',
        answer:
          'It is a natural assumption and it is not correct. An oversized furnace heats the air fast, satisfies the thermostat, and shuts down, then does it again. Those short cycles mean the blower never runs long enough to circulate air properly, so the house ends up with uneven temperatures and a drafty feel, and the equipment wears faster. In a cold climate the goal is a furnace correctly sized to hold the house through a long cold stretch, not the largest one that will fit.',
      },
      {
        question: 'What is a cracked heat exchanger and why does it matter?',
        answer:
          'The heat exchanger is the metal barrier that separates the combustion gases from the air that gets blown into your home. When it cracks, that separation is compromised and combustion byproducts, including carbon monoxide, can enter the air the house is breathing. It is a safety matter rather than an efficiency one, and it is the clearest single reason to take a furnace out of service.',
      },
      {
        question: 'Why does venting matter so much on a furnace?',
        answer:
          'Because a furnace burns fuel, and everything it burns has to leave the house. The venting is what carries the combustion gases out. If it is blocked, poorly sized, or not routed correctly, those gases have somewhere else to go, and that includes carbon monoxide. It is the part of a heating system where a mistake is a safety problem rather than a comfort one, which is why it deserves attention whenever a furnace is replaced.',
      },
      {
        question: 'Should I replace my furnace and air conditioner together?',
        answer:
          'It is worth considering when both are aging, because the two systems share the ductwork and the air conditioner coil typically sits in the furnace airflow. Doing them together can save opening the same equipment up twice. If the air conditioner is sound and has years left in it, there is no reason to replace it early just because the furnace is due.',
      },
    ],
    related: ['furnace-repair', 'ac-installation', 'hvac-maintenance'],
  },

  'heat-pump-services': {
    supportingParagraphs: [
      'A heat pump is one system that does both jobs. In summer it works like an air conditioner, moving heat out of the house. In winter it reverses, pulling heat from the outdoor air and moving it inside. It does not burn fuel to create heat, it relocates heat that already exists, which is why a heat pump can deliver more heat energy than the electrical energy it consumes.',
      'That gives it a distinctive set of behaviors that are easy to mistake for faults. A heat pump delivers air that is warm rather than hot, so the vents feel cooler to the hand than a furnace even when the system is working correctly. It runs long, steady cycles rather than short hot blasts, which is by design. And in cold weather it periodically reverses itself briefly to melt frost off the outdoor coil, which is the defrost cycle, and it produces steam, a whoosh, and a short pause in heating that homeowners often report as a problem when it is the system working as intended.',
      'In a Cache Valley winter, backup heat matters. As outdoor temperatures fall, there is less heat in the air for the system to gather, so most installations pair the heat pump with a supplemental heat source for the coldest stretches. We repair, install, and maintain heat pumps, including the reversing valve, the defrost control, and the refrigerant circuit that this equipment depends on more heavily than a conventional system does.',
    ],
    signsHeading: 'Signs Your Heat Pump May Need Service',
    signs: [
      {
        title: 'It heats but not cools, or cools but not heats',
        body: 'A system that works in one mode and not the other points at the reversing valve, which is the component that flips the refrigerant flow.',
      },
      {
        title: 'The outdoor unit stays iced over',
        body: 'Brief frost that clears is normal defrost behavior. A unit that stays encased in ice means the defrost cycle is not doing its job.',
      },
      {
        title: 'It runs constantly without holding temperature',
        body: 'Long cycles are normal for a heat pump. Never reaching the setpoint on a moderate day is not.',
      },
      {
        title: 'The backup heat is running all the time',
        body: 'If auxiliary heat is engaging on mild days, the heat pump is not carrying the load it should be, and that gets expensive.',
      },
      {
        title: 'New noises from the outdoor unit',
        body: 'Grinding, screeching, or loud clanking are mechanical signals. A hissing sound can indicate a refrigerant leak.',
      },
      {
        title: 'Energy costs are climbing',
        body: 'Rising bills often mean the system is leaning on supplemental heat more than it should, which is worth diagnosing.',
      },
    ],
    causesHeading: 'Common Causes of Heat Pump Problems',
    causes: [
      {
        title: 'A failing reversing valve',
        body: 'The reversing valve is what lets one system both heat and cool. When it sticks or fails, the unit gets stuck in one mode, which is the signature heat pump fault.',
      },
      {
        title: 'Defrost cycle faults',
        body: 'The system needs to shed frost from the outdoor coil in cold weather. When the defrost control or sensor fails, ice builds up and the unit loses its ability to gather heat.',
      },
      {
        title: 'Low refrigerant from a leak',
        body: 'A heat pump depends on its refrigerant charge in both directions. A leak degrades heating and cooling performance, and the leak itself is the repair.',
      },
      {
        title: 'A dirty or blocked outdoor coil',
        body: 'The outdoor coil has to exchange heat with the air. Blocked by debris, snow, or vegetation, it cannot, and capacity drops in both modes.',
      },
      {
        title: 'Auxiliary heat engaging too readily',
        body: 'When controls or staging are set up incorrectly, expensive backup heat runs when the heat pump could have handled the load on its own.',
      },
      {
        title: 'Restricted airflow indoors',
        body: 'A clogged filter or duct restriction hurts a heat pump in both heating and cooling, since it relies on moving a lot of air across the indoor coil.',
      },
    ],
    faqs: [
      {
        question: 'Why does my heat pump blow air that feels cool?',
        answer:
          'This is normal and it is the most common heat pump question we hear. A heat pump delivers air that is warm but not hot, typically well below the temperature a gas furnace produces. Because it is closer to body temperature, it can feel cool against your hand even while it is genuinely warming the house. The system heats by running longer, steadier cycles rather than short hot blasts.',
      },
      {
        question: 'My heat pump is steaming and making noise in winter. Is it broken?',
        answer:
          'Almost certainly not. What you are seeing is the defrost cycle. In cold weather frost accumulates on the outdoor coil, and the system briefly reverses itself to melt it off, which produces steam, a whooshing sound, and a short pause in heating. It is the system working as designed. What is not normal is an outdoor unit that stays encased in ice, which means the defrost cycle is failing.',
      },
      {
        question: 'Does a heat pump work in a Cache Valley winter?',
        answer:
          'Heat pumps work by gathering heat from outdoor air, and there is less of it available as the temperature drops, so capacity falls in genuinely cold weather. That is why installations in a climate like this one are generally paired with a supplemental heat source for the coldest stretches. The heat pump carries the load through most of the season and the backup covers the extremes.',
      },
      {
        question: 'Why is my backup heat running so much?',
        answer:
          'Auxiliary heat is meant to assist when the heat pump cannot keep up in very cold weather. If it is engaging on mild days, something is wrong, and it is worth addressing because backup heat is the expensive way to warm a house. Common reasons include low refrigerant, a defrost or reversing valve problem, restricted airflow, or controls that are set to bring the backup in too eagerly.',
      },
      {
        question: 'Is a heat pump the same as an air conditioner?',
        answer:
          'Mechanically they are close relatives, and in cooling mode a heat pump does essentially what an air conditioner does. The difference is the reversing valve, which lets a heat pump run the refrigerant cycle backwards and move heat into the house instead of out of it. That one component is what turns a cooling only machine into a system that handles both seasons.',
      },
    ],
  ...
  'hvac-maintenance': {
    supportingParagraphs: [
      'Most heating and cooling failures give warning before they happen. A capacitor that is weakening, a flame sensor that is fouling, a coil that is gradually loading up with dust, a refrigerant charge that is slowly dropping because of a small leak. None of these announce themselves. All of them are visible to someone looking for them, which is the entire argument for maintenance.',
      'The work itself is unglamorous and it is what keeps a system healthy. Filters get changed, because a restricted filter is the single most common cause of both furnace and air conditioner problems. Coils get cleaned, because a coil that cannot exchange heat costs you capacity and efficiency. Airflow and refrigerant get checked. Electrical connections get inspected, because loose connections and worn contactors cause a large share of no heat and no cool calls. Combustion gets looked at on a furnace, which is a safety matter as much as a performance one.',
      'The seasonal timing is simple and it is worth following. Look at cooling equipment in spring, before the first hot stretch. Look at heating equipment in fall, before the first hard freeze. The point is to find a problem on a mild day when the system is not being depended on, rather than on the night it fails while the house is cold.',
    ],
    signsHeading: 'When to Schedule Heating & Cooling Maintenance',
    signs: [
      {
        title: 'Before the cooling season',
        body: 'Spring, ahead of the first hot week. An air conditioner that is marginal will keep up in May and fail in July, so it is better to find out in May.',
      },
      {
        title: 'Before the heating season',
        body: 'Fall, ahead of the first hard freeze. A furnace that has sat unused all summer is worth checking before you need it every night.',
      },
      {
        title: 'Energy bills are creeping up',
        body: 'Rising costs for the same comfort usually mean the system is working harder than it should. That is often something maintenance can find.',
      },
      {
        title: 'The system has not been serviced in a long time',
        body: 'Equipment that has run for years without attention has accumulated dust, drift, and wear that nobody has looked at.',
      },
      {
        title: 'Comfort has changed subtly',
        body: 'Longer run times, uneven rooms, or airflow that is not what it was are early signals worth investigating before they become failures.',
      },
      {
        title: 'You have just moved into the home',
        body: 'Inheriting an unfamiliar system is a good reason to establish what condition it is actually in.',
      },
    ],
    causesHeading: 'Reasons to Keep Up With Maintenance',
    causes: [
      {
        title: 'It catches small problems early',
        body: 'A weakening capacitor or a fouling flame sensor is a routine fix when it is found, and a no heat call in January when it is not.',
      },
      {
        title: 'It protects efficiency',
        body: 'A dirty coil, a clogged filter, and a low refrigerant charge all make the system work harder for the same result, and you pay for that on the bill.',
      },
      {
        title: 'It extends equipment life',
        body: 'A system that is not fighting restricted airflow or a fouled coil runs under less strain, and less strain means less wear.',
      },
      {
        title: 'It supports safety on combustion equipment',
        body: 'On a furnace, inspecting the burner, the venting, and the heat exchanger is not just about performance. It is about what the equipment is doing with its exhaust.',
      },
      {
        title: 'It reduces surprise failures',
        body: 'Equipment fails on the hottest and coldest days because that is when it is working hardest. Maintenance is how you improve your odds on those days.',
      },
      {
        title: 'It maintains steady comfort',
        body: 'Clean filters and coils and correct airflow are what keep a house evenly conditioned instead of hot and cold by room.',
      },
    ],
    faqs: [
      {
        question: 'How often should heating and cooling equipment be serviced?',
        answer:
          'The common approach is to look at the cooling side in spring and the heating side in fall, so each system gets attention before the season it has to carry. If a home has a heat pump, which runs year round, it is working in both seasons and benefits from being checked on that same rhythm.',
      },
      {
        question: 'Is maintenance worth it if the system seems to be working fine?',
        answer:
          'That is exactly when it is worth doing. Maintenance is not a repair, it is a chance to find the problems that have not surfaced yet. A capacitor drifting out of spec, a flame sensor beginning to foul, a coil loading up with dust, a charge that is slightly low from a small leak. None of those stop a system today. All of them will eventually, and the timing tends to be inconvenient.',
      },
      {
        question: 'How often should I change my filter?',
        answer:
          'It depends on the filter and the household. A thin filter needs changing much more often than a thick pleated one, and pets, dust, and how much the system runs all shorten the interval. The practical approach is to look at it monthly during heavy use and change it when it looks loaded rather than following a fixed date. A restricted filter is the most common cause of heating and cooling problems, and it is the one thing a homeowner can stay ahead of without any tools.',
      },
      {
        question: 'Will maintenance lower my energy bills?',
        answer:
          'It generally helps, though we are not going to put a number on it. The mechanism is straightforward. A clean coil exchanges heat better than a dirty one. A clear filter lets the blower move air without straining. A correct refrigerant charge means the system delivers the capacity it was designed to deliver. Each of those means the system runs less to produce the same comfort.',
      },
      {
        question: 'What actually gets checked during maintenance?',
        answer:
          'On the cooling side, the filter, the coils, airflow, refrigerant charge, the condensate drain, and the electrical components including the capacitor and contactor. On the heating side, the filter, the burner and ignition components, the flame sensor, the blower, venting, and the general condition of the heat exchanger. Across both, the electrical connections, because loose connections and worn contacts cause a great many no heat and no cool calls.',
      },
    ],
    related: ['furnace-repair', 'ac-repair', 'heat-pump-services'],
  },
};
